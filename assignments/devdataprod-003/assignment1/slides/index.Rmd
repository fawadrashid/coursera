...
This is a Shiny app that visualizes USA arrests dataset. The application allows user to select a crime type and see the crime across states using a barplot
